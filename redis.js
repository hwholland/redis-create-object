...
function redis(redisHost, redisPort, redisInstance) {
    ...
    this.raven.config('https://ea5f40d074f34d0d9f741c3c66376b85@sentry.io/1222893').install();
...
redis.prototype.save = function(list, value) {
    var that = this;
    this.client.rpush(list, value, function(error, response) {
        if (error) {
